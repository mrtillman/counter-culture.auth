...
namespace counterculture.secure.server.Migrations
{
    public partial class SecureDbMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    homepage_uri = table.Column<string>(nullable: true),
                    redirect_uri = table.Column<string>(nullable: true),
                    grant_types = table.Column<string>(nullable: true),
                    scope = table.Column<string>(nullable: true),
                    user_id = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_oauth_clients", x => x.client_id);
                });
